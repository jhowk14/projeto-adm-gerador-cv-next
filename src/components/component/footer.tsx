...
export function Footer(prop: {git: string, youtube: string, twitter: string}) {
  return (
    <footer className="dark bg-gray-900 text-gray-200 py-6">
      <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex items-center justify-center space-x-4">
          ...
          <Link className="text-gray-400 hover:text-gray-100 transition-colors" href={prop.twitter}>
